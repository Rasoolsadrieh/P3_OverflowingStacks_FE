...
export default function CustomerLogin() {
  ...
  return (
    ...
    >
          ...
          <TextField id="outlined-basic" label="Please enter your Email" variant="outlined" inputRef={EmailInput} />
          <br></br>
          <FormControl sx={{ m: 1, width: '28ch' }} variant="outlined" inputRef={PasswordInput}>
